...
class MenuRolController extends Controller
{
    ...
    {
        //pluck se utiliza para consultar y obtener solo los parametros
        //que se pasan. En este caso obtenemos roles solo con el nombre y el id
        $rols = Rol::orderBy('id')->pluck('nombre','id')->toArray();
        //$key seria el id y $value seria el nombre en este caso
        foreach ($rols as $key => $value) {
            # code...
        }
        $menus = Menu::getMenu();
        //Trae los menus con sus roles, el pluck hace que los roles solo traigan su id
